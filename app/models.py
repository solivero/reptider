...
class Lesson(db.Model):
    ...
    start_sec = db.Column(db.Integer)
    end_sec = db.Column(db.Integer)
    subject = db.Column(db.Unicode(40))
    info = db.Column(db.Unicode(255))
    teachers = db.Column(db.Unicode(40))
    _class = db.Column(db.Unicode(40))
    rooms = db.Column(db.Unicode(500))
